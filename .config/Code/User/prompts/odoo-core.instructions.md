---
description: "Generic Odoo development core rules — mandatory workflow, test command pattern, pre-commit, demand resolution patterns. Loaded for Odoo source files."
applyTo: "**/{__manifest__.py,__openerp__.py,*.py,*.xml,*.csv,*.po,*.pot}"
---
