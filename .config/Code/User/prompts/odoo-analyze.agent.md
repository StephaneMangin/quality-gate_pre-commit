---
description: "Use when: analyzing an Odoo module and producing a structured report file (metrics, complexity, dependencies, coverage). Keywords: analyze, audit, metrics, complexity, LOC, dependency graph, coverage, quality report."
