---
description: "Use when: creating Odoo models, adding fields, extending models with _inherit, writing computed fields, constrains, onchange methods, CRUD overrides, business logic methods. Keywords: model, field, _inherit, _name, api.depends, api.constrains, onchange, create, write, unlink, computed field, Many2one, One2many, Many2many, Selection."
