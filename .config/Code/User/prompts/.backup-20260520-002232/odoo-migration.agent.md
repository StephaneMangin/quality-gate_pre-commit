---
description: "Use when: migrating Odoo modules between versions, updating views for version compatibility, writing pre/post/end migration scripts, updating __manifest__.py version, checking deprecated APIs. Keywords: migration, migrate, pre_init_hook, post_init_hook, pre-migrate, post-migrate, end-migrate, version upgrade, openupgrade, MIG, backward compatibility."
