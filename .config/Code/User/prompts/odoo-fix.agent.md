---
description: "Use when: applying a bounded bug fix on EXISTING code only — USER FIX keyword, no new files, regression test added to an existing test file. Keywords: USER FIX, bug, fix, patch, regression, hotfix."
