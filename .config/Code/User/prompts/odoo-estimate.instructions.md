---
description: "Generic Odoo effort-estimation methodology — ideal developer-days, phase decomposition, risk separation, profile coefficients. Loaded only when estimating an Odoo demand (via the demand_analysis skill or explicit <USER ESTIMATE> trigger)."
---
