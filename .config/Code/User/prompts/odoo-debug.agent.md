---
description: "Use when: diagnosing Odoo errors, tracebacks, performance issues, N+1 queries. Read-only. Keywords: debug, error, traceback, AccessError, ValidationError, performance, slow, N+1."
---
